...
struct Node_Fb FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const Point_Fb *position() const {
    return GetPointer<const Point_Fb *>(VT_POSITION);
  }
...
struct Node_FbBuilder {
  ...
  void add_position(flatbuffers::Offset<Point_Fb> position) {
...
inline flatbuffers::Offset<Node_Fb> CreateNode_Fb(
    ...
    flatbuffers::Offset<Point_Fb> position = 0) {
...
struct Layer_Fb FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const Node_Fb *super() const {
    return GetPointer<const Node_Fb *>(VT_SUPER);
  }
  const Node_Fb *friend_() const {
    return GetPointer<const Node_Fb *>(VT_FRIEND_);
  }
  const flatbuffers::Vector<flatbuffers::Offset<Node_Fb>> *children() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<Node_Fb>> *>(VT_CHILDREN);
  }
  const flatbuffers::Vector<flatbuffers::Offset<Point_Fb>> *transform() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<Point_Fb>> *>(VT_TRANSFORM);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct Layer_FbBuilder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_super(flatbuffers::Offset<Node_Fb> super) {
    fbb_.AddOffset(Layer_Fb::VT_SUPER, super);
  }
  void add_friend_(flatbuffers::Offset<Node_Fb> friend_) {
    fbb_.AddOffset(Layer_Fb::VT_FRIEND_, friend_);
  }
  void add_children(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Node_Fb>>> children) {
    fbb_.AddOffset(Layer_Fb::VT_CHILDREN, children);
  }
  void add_transform(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Point_Fb>>> transform) {
...
inline flatbuffers::Offset<Layer_Fb> CreateLayer_Fb(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<Node_Fb> super = 0,
    flatbuffers::Offset<Node_Fb> friend_ = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Node_Fb>>> children = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Point_Fb>>> transform = 0) {
...
inline flatbuffers::Offset<Layer_Fb> CreateLayer_FbDirect(
    ...
    flatbuffers::Offset<Node_Fb> super = 0,
    flatbuffers::Offset<Node_Fb> friend_ = 0,
    const std::vector<flatbuffers::Offset<Node_Fb>> *children = nullptr,
    const std::vector<flatbuffers::Offset<Point_Fb>> *transform = nullptr) {
  auto children__ = children ? _fbb.CreateVector<flatbuffers::Offset<Node_Fb>>(*children) : 0;
  auto transform__ = transform ? _fbb.CreateVector<flatbuffers::Offset<Point_Fb>>(*transform) : 0;
